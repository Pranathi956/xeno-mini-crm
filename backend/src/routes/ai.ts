...
import { AiChatBody } from "../validators.js";
...
router.post("/ai/chat", async (req, res): Promise<void> => {
  ...
  try {
    ...
    let parsed2: { reply?: string; action?: string | null; segment_query?: string | null; message_draft?: string | null; channel?: string | null };
    try { parsed2 = JSON.parse(cleaned); } catch { parsed2 = { reply: rawContent, action: null }; }
